...
>
	<form
		class="w-full max-w-md p-8 m-8 space-y-4 rounded-md shadow-2xl bg-white"
		on:submit|preventDefault={handleLogin}
	>
		<h2 class="text-3xl font-semibold text-center text-pink-600">Login</h2>
		<div class="space-y-2">
		...
		<div class="pt-4 flex flex-col items-center">
			<Button variant="primary" block outline type="submit">Login</Button>
		</div>
	</form>
</div>
